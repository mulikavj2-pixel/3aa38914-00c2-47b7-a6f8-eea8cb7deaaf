...
export const metadata: Metadata = {
  title: "Brew Haven - Specialty Coffee & Craft Espresso",
  description: "Experience exceptional specialty coffee from ethically sourced beans. Expert baristas, premium roasts, and a welcoming community await you.",
  keywords: "specialty coffee, espresso, coffee shop, craft coffee, barista, ethically sourced, coffee culture",
  ...
  openGraph: {
    ...
    description: "Discover handcrafted coffee from ethically sourced beans, expertly roasted and carefully brewed.",
    type: "website",
    siteName: "Brew Haven",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766156762677-7lz9g9so.jpg",
  ...
  twitter: {
    ...
    description: "Experience the art of coffee making with our premium specialty blends.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766156762677-7lz9g9so.jpg"]
  }
};
